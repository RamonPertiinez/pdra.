      ...
      <main className="flex-1 px-6 py-28 md:px-10">
        <div className="mx-auto max-w-6xl grid gap-10 lg:grid-cols-[420px_minmax(0,1fr)]">
          ...
          >
            ...
            <h1 className="mt-5 text-3xl md:text-4xl leading-[1.04] text-balance">
              {t("access_title_new")}
            </h1>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-[20px] bg-background p-4 shadow-inner-border">
                <p className="text-[11px] uppercase tracking-[0.16em] text-stone font-mono-tech">
            ...
            {!isApproved ? (
              ...
              <div className="mt-10 rounded-[24px] bg-background p-6 shadow-inner-border">
                <p className="text-xs uppercase tracking-[0.15em] text-stone font-mono-tech">
                  {t("access_granted")}
                </p>
                ...
                {state.user.rewardCode && (
                  <div className="mt-5 rounded-[18px] border border-foreground/8 bg-foreground text-background p-4">
                    <p className="text-[11px] uppercase tracking-[0.16em] text-background/65 font-mono-tech">
          ...
          >
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-white/45 font-mono-tech">
                  {t("clue_hub_label")}
                </p>
                <h2 className="mt-3 text-3xl leading-tight text-balance">
                  {t("clue_hub_title")}
                </h2>
              </div>
            ...
            <p className="mt-5 max-w-3xl text-white/68 leading-relaxed">
              {t("clue_hub_body")}
            </p>
            ...
            <div className="mt-10 grid gap-4 xl:grid-cols-3">
              {clues.map((clue) => {
                ...
                return (
                  <div
                    key={clue.id}
                    className={`rounded-[28px] border border-white/10 bg-gradient-to-br ${clue.accent} p-6 shadow-[0_18px_60px_rgba(0,0,0,0.22)]`}
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <p className="text-[11px] uppercase tracking-[0.18em] text-white/42 font-mono-tech">
                          {clue.category}
                        </p>
                      ...
                      <span
                        className={`rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.16em] font-mono-tech ${
                          unlocked
                            ? "bg-white text-black"
                    ...
                    <div className="mt-6 rounded-[18px] border border-white/10 bg-black/20 p-4">
                      <p className="text-[10px] uppercase tracking-[0.16em] text-white/42 font-mono-tech">
                    ...
                    <p className="mt-5 text-[11px] uppercase tracking-[0.16em] text-white/42 font-mono-tech">
                      {clue.passwordHint}
                    </p>
            ...
            <div
              className={`mt-8 rounded-[28px] p-6 transition-pdra ${
                allCluesUnlocked
                  ? "bg-white text-black"
                  : "border border-dashed border-white/12 bg-white/5 text-white"
              }`}
            >
              <p
                className={`text-[11px] uppercase tracking-[0.18em] font-mono-tech ${
                  allCluesUnlocked ? "text-black/45" : "text-white/42"
                }`}
              >
                {t("clue_final_label")}
              </p>
              ...
              <p
                className={`mt-4 text-sm leading-relaxed ${
                  allCluesUnlocked ? "text-black/68" : "text-white/62"
                }`}
              >
                {allCluesUnlocked
